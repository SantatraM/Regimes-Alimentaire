        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="<?php echo site_url('General/insert_utilisateur'); ?>" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="objectif"> SEXE </label>
                    <select name="sexe" >
                        <?php foreach($sexe as $sexes) { ?>
                        <option value="<?php echo $sexes['id_sexe']; ?>" ><?php echo $sexes['type']; ?></option>
                        <?php } ?>
                    </select>
                </div>
